        ...
        <tr style="width:100%">
          <td>
            <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation">
              <tbody>
                <tr>
                  <td><img alt="Airbnb" height="30" src="https://react-email-demo-7s5r0trkn-resend.vercel.app/static/airbnb-logo.png" style="display:block;outline:none;border:none;text-decoration:none" width="96" /></td>
                </tr>
              </tbody>
            </table>
            <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation">
              <tbody>
                <tr>
                  <td><img alt="Alex" height="96" src="https://react-email-demo-7s5r0trkn-resend.vercel.app/static/airbnb-review-user.jpg" style="display:block;outline:none;border:none;text-decoration:none;margin:0 auto;margin-bottom:16px;border-radius:50%" width="96" /></td>
                </tr>
              </tbody>
            </table>
                    ...
                    <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation">
                      <tbody style="width:100%">
                        <tr style="width:100%">
                          ...
                          <p style="font-size:18px;line-height:1.4;margin:16px 0;color:#484848;padding-bottom:16px">While it’s too late to write a review of your own, you can send your feedback to <!-- -->Alex<!-- --> using your Airbnb message thread.</p><a href="https://airbnb.com/" style="background-color:#ff5a5f;border-radius:3px;color:#fff;font-size:18px;padding-top:19px;padding-bottom:19px;text-decoration:none;text-align:center;display:inline-block;width:100%;line-height:100%;max-width:100%;padding:19px 0px 19px 0px" target="_blank"><span><!--[if mso]><i style="letter-spacing: 0px;mso-font-width:-100%;mso-text-raise:28.5" hidden>&nbsp;</i><![endif]--></span><span style="max-width:100%;display:inline-block;line-height:120%;mso-padding-alt:0px;mso-text-raise:14.25px">Send My Feedback</span><span><!--[if mso]><i style="letter-spacing: 0px;mso-font-width:-100%" hidden>&nbsp;</i><![endif]--></span></a>
                        </tr>
                      </tbody>
                    </table>
                  </td>
